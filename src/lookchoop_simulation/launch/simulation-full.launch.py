...
def generate_launch_description():
    ...
    # Package shares
    desc_pkg = get_package_share_directory('lookchoop_description')
    sim_pkg = get_package_share_directory('lookchoop_simulation')
    ...
    xacro_file = PathJoinSubstitution([FindPackageShare('lookchoop_description'), 'urdf', 'robot_core.xacro'])
    ...
    # RViz
    rviz_config = os.path.join(sim_pkg, 'rviz', 'config.rviz')
    rviz = Node(
